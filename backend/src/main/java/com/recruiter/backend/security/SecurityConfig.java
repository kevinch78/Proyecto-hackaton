    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // WARNING: This line is for testing purposes only and disables ALL security.
                        // DO NOT USE IN PRODUCTION!
                        .anyRequest().permitAll()
                );
                // The following lines are commented out or removed to completely disable security filters for testing.
                // DO NOT USE IN PRODUCTION!
